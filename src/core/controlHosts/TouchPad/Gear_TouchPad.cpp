...
const QString Gear_TouchPad::SETTING_HORIZONTAL_LOWERBOUND = "Horizontal lower Bound";
const QString Gear_TouchPad::SETTING_HORIZONTAL_HIGHERBOUND = "Horizontal higher Bound";
