...
/*     _fftwPlan = rfftw_create_plan(_windowSize, FFTW_REAL_TO_COMPLEX, FFTW_ESTIMATE);       */
/*                                                                                            */
/*     _fftwPlanInvert = rfftw_create_plan(_windowSize, FFTW_COMPLEX_TO_REAL, FFTW_ESTIMATE); */
/*                                                                                            */
...
/*                                                                                            */
/*                                                                                            */
/*     //allocate _inputComplex and set to 0                                                  */
/*     if (_inputComplex!=NULL)                                                               */
/*         delete[] _inputComplex;                                                            */
/*                                                                                            */
/*     _inputComplex = new fftw_real[_windowSize];                                            */
/*     for (int i=0;i<_windowSize;i++)                                                        */
/*     {                                                                                      */
/*         _inputComplex[i] = 0.0f;                                                           */
/*     }                                                                                      */
/*                                                                                            */
/*     //allocate _outputComplex                                                              */
/*     if (_outputComplex!=NULL)                                                              */
/*         delete _outputComplex;                                                             */
/*                                                                                            */
/*     _outputComplex = new fftw_real[_windowSize];                                           */
/*                                                                                            */
...
/*         _inputComplex[i]=0.0;                                     */
/*                                                                   */
/*     rfftw_one(_fftwPlanInvert, _inputComplex, _outputComplex);    */
/*                                                                   */
...
/*         _inputComplex[i]=0.0;                                                                                                                        */
/*                                                                                                                                                      */
/*     rfftw_one(_fftwPlan, _inputComplex, _outputComplex);                                                                                             */
/*                                                                                                                                                      */
...
/*     rfftw_one(_fftwPlan, _inputComplex, _outputComplex);                                                     */
/*                                                                                                              */
/*     rfftw_one(_fftwPlanInvert, _outputComplex, _backComplex);                                                */
/*                                                                                                              */
/*     for (int i=0; i<_bufferSize; i++)                                                                        */
