#ifndef GEAR_COLORQUANTIZEWU_INCLUDED
#define GEAR_COLORQUANTIZEWU_INCLUDED
...
class Gear_ColorQuantizeWu : public Gear  
{
public:
  Gear_ColorQuantizeWu(Engine *engine, std::string name);
  virtual ~Gear_ColorQuantizeWu();
