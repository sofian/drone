...
import drone.jmf.actor.CivilCameraActor;
...
public class CivilCameraActorDemo {
	...
	public static void main(String[] args) throws NameDuplicationException, IllegalActionException {
			...
			String period = Double.toString(1.0 / 15.0);
			...
			// Create two actors.
			CivilCameraActor reader = new CivilCameraActor(top, "reader");
