...
#include <jni.h>
/* Header for class ptolemy_actor_lib_artkp_kernel_Tracker */

#ifndef _Included_ptolemy_actor_lib_artkp_kernel_Tracker
#define _Included_ptolemy_actor_lib_artkp_kernel_Tracker
#ifdef __cplusplus
extern "C" {
#endif
/*
