...
def convertImplTypes(s):
    ...
    s = re.sub("->buffer\(\)\[(\d*)\]", "->type()->value()",s)
    s = re.sub("->buffer\(\)", "->type()->value()",s)
    s = re.sub("Video_T", "MatrixType<RGBA>",s)
    s = re.sub("Signal_T\s\*", "MatrixType<float> ",s)
    s = re.sub("Signal_T", "float ",s)
    return s
...
def convertHeaderFile(s):
    ...
    s = convertOldStylePlugs(s, "PlugSignalIn", "PlugIn<ValueType>");
    s = convertOldStylePlugs(s, "PlugSignalOut", "PlugOut<ValueType>");
...
def convertImplFile(s):
    ...
    s = convertAddPlugs(s, "PlugSignalIn", "PlugIn", "ValueType");
    s = convertAddPlugs(s, "PlugSignalOut", "PlugOut", "ValueType");
